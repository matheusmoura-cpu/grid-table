...
export function CardView({ data, visibleColumns, matches, selectedIds, onToggleRow, onSiteClick, rowActions, onAction }: CardViewProps) {
  if (data.length === 0) {
    return (
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-1.5 ml-2 flex-shrink-0">
                ...
                {/* Wrap in group/row so RowActionsMenu can apply hover visibility */}
